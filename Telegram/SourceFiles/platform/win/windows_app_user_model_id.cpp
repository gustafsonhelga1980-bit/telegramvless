...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"gustafsonhelga1980-bit.TeVLESS.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"gustafsonhelga1980-bit.TeVLESS";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	const auto path = systemShortcutPath() + AppName.utf16() + u".lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = AppName.utf16()
		+ '/'
		+ AppName.utf16()
		+ u".lnk"_q;
