...
add_executable(test_socks5_udp_socket)
init_target(test_socks5_udp_socket "(tests)")

target_include_directories(test_socks5_udp_socket
PRIVATE
    ${call_proxy_tgcalls_loc}
)

nice_target_sources(test_socks5_udp_socket ${src_loc}
PRIVATE
    tests/test_socks5_udp_socket.cpp
)

nice_target_sources(test_socks5_udp_socket ${call_proxy_tgcalls_loc}
PRIVATE
    v2/Socks5UdpSocketFactory.cpp
    v2/Socks5UdpSocketFactory.h
)

target_link_libraries(test_socks5_udp_socket
PRIVATE
    desktop-app::external_webrtc
)

set_target_properties(test_socks5_udp_socket PROPERTIES
    RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}
)

add_test(
    NAME socks5_udp_socket
    COMMAND "../$<CONFIG>/test_socks5_udp_socket"
)
set_tests_properties(socks5_udp_socket PROPERTIES TIMEOUT 30)

add_custom_target(check_socks5_udp_socket
    COMMAND $<TARGET_FILE:test_socks5_udp_socket>
    VERBATIM
)
